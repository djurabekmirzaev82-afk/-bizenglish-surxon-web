...
const MODULES = [
  ...
  { id: "vocabulary", icon: "🗂", name: "Vocabulary", desc: "Kartochkalar orqali so'z boyligini oshiring", live: true },
];

// So'z boyligi bazasi — CEFR darajalari va mavzular bo'yicha.
// Backend'siz ishlaydi, brauzerda saqlanadi (progress uchun localStorage).
const VOCAB_WORDS = [
  { id: "v1", level: "A1", topic: "Umumiy", term: "meeting", translation: "yig'ilish", def: "A planned gathering of people to discuss something.", example: "We have a meeting at 10 AM." },
  { id: "v2", level: "A1", topic: "Umumiy", term: "customer", translation: "mijoz", def: "A person who buys goods or services.", example: "The customer asked for a refund." },
  { id: "v3", level: "A1", topic: "Umumiy", term: "invoice", translation: "hisob-faktura", def: "A document listing goods sold and the amount owed.", example: "Please send the invoice by Friday." },
  { id: "v4", level: "A2", topic: "Ofis", term: "deadline", translation: "muddat", def: "The latest time by which something must be finished.", example: "The deadline for the report is tomorrow." },
  { id: "v5", level: "A2", topic: "Ofis", term: "colleague", translation: "hamkasb", def: "A person you work with.", example: "My colleague helped me finish the project." },
  { id: "v6", level: "A2", topic: "Moliya", term: "budget", translation: "byudjet", def: "A plan for how money will be spent.", example: "We need to stay within budget this quarter." },
  { id: "v7", level: "B1", topic: "Moliya", term: "revenue", translation: "daromad", def: "The total income generated by a business.", example: "Revenue increased by 15% last year." },
  { id: "v8", level: "B1", topic: "Moliya", term: "expenditure", translation: "xarajat", def: "The amount of money spent on something.", example: "Company expenditure was higher than expected." },
  { id: "v9", level: "B1", topic: "Marketing", term: "target audience", translation: "maqsadli auditoriya", def: "The specific group a product or service is aimed at.", example: "Our target audience is young professionals." },
  { id: "v10", level: "B1", topic: "Muzokara", term: "negotiate", translation: "muzokara olib bormoq", def: "To discuss something to reach an agreement.", example: "They negotiated a better price with the supplier." },
  { id: "v11", level: "B2", topic: "Muzokara", term: "compromise", translation: "murosaga kelish", def: "An agreement reached by each side giving up something.", example: "Both sides reached a compromise after long talks." },
  { id: "v12", level: "B2", topic: "Strategiya", term: "stakeholder", translation: "manfaatdor tomon", def: "A person or group with an interest in a company's decisions.", example: "We consulted key stakeholders before the launch." },
  { id: "v13", level: "B2", topic: "Strategiya", term: "outsource", translation: "tashqi manbadan foydalanish", def: "To pay another company to do a part of your work.", example: "We outsource our IT support to a local firm." },
  { id: "v14", level: "B2", topic: "Moliya", term: "asset", translation: "aktiv", def: "Something valuable that a company owns.", example: "Real estate is a major asset for the company." },
  { id: "v15", level: "C1", topic: "Strategiya", term: "leverage", translation: "afzallikdan foydalanish", def: "To use something to maximum advantage.", example: "The firm leveraged its brand to enter new markets." },
  { id: "v16", level: "C1", topic: "Moliya", term: "liquidity", translation: "likvidlik", def: "The availability of liquid assets to a company or market.", example: "The bank ensured sufficient liquidity during the crisis." },
  { id: "v17", level: "C1", topic: "Marketing", term: "market saturation", translation: "bozor to'yinganligi", def: "The point where a market can absorb no more of a product.", example: "Market saturation forced them to look abroad." },
  { id: "v18", level: "C2", topic: "Strategiya", term: "synergy", translation: "sinergiya", def: "The extra value created when things work together effectively.", example: "The merger created synergy between the two teams." },
  { id: "v19", level: "C2", topic: "Moliya", term: "diversification", translation: "diversifikatsiya", def: "Spreading investments to reduce risk.", example: "Diversification protected the fund during the downturn." },
  { id: "v20", level: "C2", topic: "Muzokara", term: "concession", translation: "yon berish", def: "Something given up in a negotiation to reach agreement.", example: "Neither party was willing to make a concession." },
];
const VOCAB_LEVELS = ["Barchasi", ...LEVELS];
...
function VocabFlashcard({ word, flipped, onFlip }) {
  ...
  return (
    ...
    >
      {!flipped ? (
        <>
          <Badge tone="soon">{word.level} · {word.topic}</Badge>
...
function VocabularyModule({ onBack }) {
  ...
  const words = level === "Barchasi" ? VOCAB_WORDS : VOCAB_WORDS.filter((w) => w.level === level);
  ...
  return (
    <div style={{ padding: 24, maxWidth: 720, margin: "0 auto" }}>
      ...
      <ModuleHeader moduleId="vocabulary" icon="🗂" title="Vocabulary" />
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 10 }}>
        ...
        <span style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: 12, fontWeight: 600, color: COLORS.textSoft }}>
          {index + 1} / {words.length} · Bilgan so'zlar: {known}
        </span>
      </div>
