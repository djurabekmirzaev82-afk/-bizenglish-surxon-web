    ...
    <div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 10 }}>
        ...
        <span style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: 12, fontWeight: 600, color: COLORS.textSoft }}>
          {index + 1} / {words.length} · Bilgan so'zlar: {known}/{topicWords.length}
        </span>
      </div>
...
function VocabularyModule({ onBack }) {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 760, margin: "0 auto" }}>
      <BackButton onBack={activeTopic ? () => setActiveTopic(null) : onBack} />
      <ModuleHeader moduleId="vocabulary" icon="🗂" title={activeTopic ? activeTopic.name : "Vocabulary"} />
